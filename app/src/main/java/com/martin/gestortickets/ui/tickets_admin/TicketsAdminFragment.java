...
public class TicketsAdminFragment extends Fragment {
    ...
    private TicketsAdminViewModel mViewModel;

    public static TicketsAdminFragment newInstance() {
        return new TicketsAdminFragment();
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(TicketsAdminViewModel.class);
